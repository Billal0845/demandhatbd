...
const Footer = () => {
    return (
        <footer className="bg-[#2D3E29] dark:bg-[#0F1A0D] text-white">
            {/* Main Footer Content */}
            <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 lg:col-span-1">
                        ...
                        <p className="text-[#D1D5DB] dark:text-[#9CA3AF] text-sm mb-4">
                            Your one-stop shop for budget-friendly essentials.
                            Quality products at student-friendly prices for
                            singles, bachelors, and smart shoppers.
                        </p>
                    ...
                    <div>
                        ...
                        <div className="text-sm text-[#D1D5DB] dark:text-[#9CA3AF]">
                            <p className="mb-1">📧 support@budgetra.com</p>
                            <p className="mb-1">📞 +88 01234-567890</p>
                    ...
                    <div className="md:flex md:items-center md:justify-between">
                        <div className="mb-4 md:mb-0">
                            ...
                            <p className="text-[#D1D5DB] dark:text-[#9CA3AF] text-sm">
                                Get the best deals and new arrivals delivered to
                                your inbox
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-3 max-w-md">
                            <input
                                ...
                                className="flex-1 px-4 py-2 bg-[#1F2937] dark:bg-[#111827] border border-[#4B5563] dark:border-[#374151] rounded-lg text-white placeholder-[#9CA3AF] focus:outline-none focus:border-[#7CA66E] dark:focus:border-[#8FBA81]"
                            />
                ...
                <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="md:flex md:items-center md:justify-between">
                        <div className="text-sm text-[#9CA3AF]">
                            <p>&copy; 2024 Budgetra. All rights reserved.</p>
                        </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-[#4B5563] dark:border-[#374151]">
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                            ...
                            <div className="flex space-x-3">
                                ...
                                <div className="w-8 h-5 bg-[#658C58] dark:bg-[#7CA66E] rounded text-white text-xs flex items-center justify-center font-bold">
                                    GPay
                                </div>
                            </div>
                        </div>
